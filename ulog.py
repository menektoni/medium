...
#    Custom log that will print info and save it in a csv file. It extends the default python log. It also have a function to get a fancy string from time in seconds


import os


def fancyStringTimeFromSeconds(input_seconds):
    """
